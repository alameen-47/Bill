...
const translations = {
  en: {
    ...
    backupDescription: 'Send your data to email for safekeeping',
    backupNow: 'Backup Now',
    restoreData: 'Restore Data',
    restoreDescription: 'Restore data from email backup',
    restoreFromBackup: 'Restore from Backup',
    enterBackupEmail: 'Enter email address for backup',
    enterRestoreCode: 'Enter backup JSON code',
    backupSuccess: 'Backup sent to email successfully!',
    backupFailed: 'Backup failed. Please try again.',
    restoreSuccess: 'Data restored successfully!',
    restoreFailed: 'Restore failed. Please check your backup code.',
    backupStats: 'Your backup contains:',
    totalBills: 'bills',
    totalProducts: 'products',
    totalCategories: 'categories',
    sending: 'Sending...',
    restoring: 'Restoring...',
    backupEmailPlaceholder: 'your-email@example.com',
    backupCodePlaceholder: 'Paste backup JSON code here',
    sendingBackup: 'Sending backup...',
    restoringData: 'Restoring data...',
    backupSent: 'Backup Email Sent!',
  ...
  ar: {
    ...
    // Email Backup
    emailBackup: 'نسخ احتياطي البريد الإلكتروني',
    backupData: 'نسخ البيانات',
    backupDescription: 'ارسل بياناتك للبريد الإلكتروني للحفظ',
    backupNow: 'نسخ احتياطي الآن',
    restoreData: 'استعادة البيانات',
    restoreDescription: 'استعادة البيانات من النسخ الاحتياطي',
    restoreFromBackup: 'استعادة من النسخ الاحتياطي',
    enterBackupEmail: 'أدخل عنوان البريد الإلكتروني',
    enterRestoreCode: 'أدخل كود النسخ الاحتياطي',
    backupSuccess: 'تم إرسال النسخ الاحتياطي بنجاح!',
    backupFailed: 'فشل النسخ الاحتياطي. يرجى المحاولة مرة أخرى.',
    restoreSuccess: 'تم استعادة البيانات بنجاح!',
    restoreFailed: 'فشلت الاستعادة. يرجى التحقق من كود النسخ الاحتياطي.',
    backupStats: 'يحتوي النسخ الاحتياطي الخاص بك على:',
    totalBills: 'فواتير',
    totalProducts: 'منتجات',
    totalCategories: 'فئات',
    sending: 'جاري الإرسال...',
    restoring: 'جاري الاستعادة...',
    backupEmailPlaceholder: 'بريدك@مثال.com',
    backupCodePlaceholder: 'الصق كود النسخ الاحتياطي هنا',
    sendingBackup: 'جاري إرسال النسخ الاحتياطي...',
    restoringData: 'جاري استعادة البيانات...',
    backupSent: 'تم إرسال بريد النسخ الاحتياطي!',
  ...
  hi: {
    ...
    // Email Backup
    emailBackup: 'ईमेल बैकअप',
    backupData: 'डेटा बैकअप',
    backupDescription: 'सुरक्षा के लिए अपना ईमेल पर भेजें',
    backupNow: 'बैकअप करें',
    restoreData: 'डेटा रिस्टोर करें',
    restoreDescription: 'बैकअप से डेटा रिस्टोर करें',
    restoreFromBackup: 'बैकअप से रिस्टोर करें',
    enterBackupEmail: 'बैकअप के लिए ईमेल दर्ज करें',
    enterRestoreCode: 'बैकअप कोड दर्ज करें',
    backupSuccess: 'बैकअप ईमेल सफलतापूर्वक भेजा गया!',
    backupFailed: 'बैकअप विफल। कृपया पुनः प्रयास करें।',
    restoreSuccess: 'डेटा सफलतापूर्वक रिस्टोर किया गया!',
    restoreFailed: 'रिस्टोर विफल। कृपया अपना बैकअप कोड जांचें।',
    backupStats: 'आपके बैकअप में है:',
    totalBills: 'बिल',
    totalProducts: 'उत्पाद',
    totalCategories: 'श्रेणियां',
    sending: 'भेज रहा है...',
    restoring: 'रिस्टोर कर रहा है...',
    backupEmailPlaceholder: 'your-email@example.com',
    backupCodePlaceholder: 'बैकअप JSON कोड यहां पेस्ट करें',
    sendingBackup: 'बैकअप भेज रहा है...',
    restoringData: 'डेटा रिस्टोर कर रहा है...',
    backupSent: 'बैकअप ईमेल भेजा गया!',
    dataRestored: 'डेटा सफलतापूर्वक रिस्टोर हुआ!',
  ...
  ml: {
    ...
    // Email Backup
    emailBackup: 'ഇമെയിൽ ബാക്കപ്പ്',
    backupData: 'ഡാറ്റ ബാക്കപ്പ്',
    backupDescription: 'സംരക്ഷണത്തിനായി നിങ്ങളുടെ ഇമെയിലിലേക്ക് അയയ്ക്കുക',
    backupNow: 'ബാക്കപ്പ് ഇപ്പോള്‍ ചെയ്യുക',
    restoreData: 'ഡാറ്റ പുനഃസ്ഥാപിക്കുക',
    restoreDescription: 'ബാക്കപ്പില്‍ നിന്ന് ഡാറ്റ പുനഃസ്ഥാപിക്കുക',
    restoreFromBackup: 'ബാക്കപ്പില്‍ നിന്ന് പുനഃസ്ഥാപിക്കുക',
    enterBackupEmail: 'ബാക്കപ്പിനായി ഇമെയില്‍ വിലാസം നല്‍കുക',
    enterRestoreCode: 'ബാക്കപ്പ് കോഡ് നല്‍കുക',
    backupSuccess: 'ബാക്കപ്പ് ഇമെയിലിലേക്ക് അയച്ചു!',
    backupFailed: 'ബാക്കപ്പ് പരാജയപ്പെട്ടു.',
    restoreSuccess: 'ഡാറ്റ പുനഃസ്ഥാപിച്ചു!',
    restoreFailed: 'പുനഃസ്ഥാപനം പരാജയപ്പെട്ടു.',
    backupStats: 'നിങ്ങളുടെ ബാക്കപ്പില്‍:',
    totalBills: 'ബില്ലുകള്‍',
    totalProducts: 'ഉത്പന്നങ്ങള്‍',
    totalCategories: 'വിഭാഗങ്ങള്‍',
    sending: 'അയയ്ക്കുന്നു...',
    restoring: 'പുനഃസ്ഥാപിക്കുന്നു...',
    backupEmailPlaceholder: 'നിങ്ങളുടെമെയില്‍@ഉദാഹരണം.com',
    backupCodePlaceholder: 'ബാക്കപ്പ് JSON കോഡ് ഇവിടെ പേസ്റ്റ് ചെയ്യുക',
    sendingBackup: 'ബാക്കപ്പ് അയയ്ക്കുന്നു...',
    restoringData: 'ഡാറ്റ പുനഃസ്ഥാപിക്കുന്നു...',
    backupSent: 'ബാക്കപ്പ് ഇമെയില്‍ അയച്ചു!',
    dataRestored: 'ഡാറ്റ വിജയകരമായി പുനഃസ്ഥാപിച്ചു!',
  ...
  ta: {
    ...
    // Email Backup
    emailBackup: 'மின்னஞ்சல் காப்புப்பிரதி',
    backupData: 'தரவு காப்புப்பிரதி',
    backupDescription: 'பாதுகாப்பதற்கு உங்கள் மின்னஞ்சலுக்கு அனுப்பவும்',
    backupNow: 'காப்புப்பிரதி எடுக்கவும்',
    restoreData: 'தரவை மீட்டெடுக்கவும்',
    restoreDescription: 'காப்புப்பிரதியிலிருந்து தரவை மீட்டெடுக்கவும்',
    restoreFromBackup: 'காப்புப்பிரதியிலிருந்து மீட்டெடுக்கவும்',
    enterBackupEmail: 'காப்புப்பிரதிக்கு மின்னஞ்சலை உள்ளிடவும்',
    enterRestoreCode: 'காப்புப்பிரதி குறியீட்டை உள்ளிடவும்',
    backupSuccess: 'காப்புப்பிரதி மின்னஞ்சலுக்கு அனுப்பப்பட்டது!',
    backupFailed: 'காப்புப்பிரதி தோல்வியடைந்தது.',
    restoreSuccess: 'தரவு வெற்றிகரமாக மீட்கப்பட்டது!',
    restoreFailed: 'மீட்பு தோல்வியடைந்தது.',
    backupStats: 'உங்கள் காப்புப்பிரதியில்:',
    totalBills: 'பில்',
    totalProducts: 'தயாரிப்புகள்',
    totalCategories: 'வகைகள்',
    sending: 'அனுப்புகிறது...',
    restoring: 'மீட்கிறது...',
    backupEmailPlaceholder: ' உங்கள்-மின்னஞ்சல்@உதாரணம்.com',
    backupCodePlaceholder: 'காப்பு JSON குறியீட்டை இங்கே ஒட்டவும்',
    sendingBackup: 'காப்புப்பிரதி அனுப்புகிறது...',
    restoringData: 'தரவை மீட்டெடுக்கிறது...',
    backupSent: 'காப்புப்பிரதி மின்னஞ்சல் அனுப்பப்பட்டது!',
    dataRestored: 'தரவு வெற்றிகரமாக மீட்கப்பட்டது!',
